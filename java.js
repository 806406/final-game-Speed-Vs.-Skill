...
//other easter eggs: the Chomper is kind of like an easter egg as he is from mario and it spawns late making it kind of like a surprise. Mario easter egg: there is a mario easter egg where if the user puts in the kunami code of up, up, down, down, left, right, left, right, on the keyboard arrow keys, then 10 marios will spawn replacing the snake and dealing a total of 50 damage to the gorilla. They only spawn once due to the level of damage that they are able to deal. 